...
0nrow(sim$cohortData)

uniqueN(sim$cohortData$pixelGroup)

nrow(sim$classification)

uniqueN(sim$classification$pixelGroup)

head(sim$classification)

head(sim$pixelGroupToAU)

length(sim$yieldTables_NL)

length(sim$AUtoCurve$AU)
# =========================================================
# =========================================================
